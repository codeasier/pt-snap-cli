...
class TestImportCommand:
    ...
    def test_import_missing_tool_message(
        ...
        """Test import reports memsnapdump installation guidance when the tool is missing."""
        ...
        def raise_missing_tool(*args: object, **kwargs: object) -> object:
            raise ImportToolMissingError(
                "memsnapdump missing; install with pip install -e .[memsnapdump]"
            )
        ...
        assert result.exit_code != 0
        assert "memsnapdump" in result.output
